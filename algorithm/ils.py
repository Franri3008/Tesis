...
testing=False; parametroFichas=0.11; entrada="etapa1"; version="C"; solucion_inicial=True; warnings.filterwarnings("ignore")
...
def load_data_and_config():
    ...
    global dfdisORA,dfdisORB,dfdisORC,dfdisORD,dfdisAffi,dfdisAffiDiario,dfdisAffiBloque
    global extras,patient,surgeon,second,room,day,nSlot,nRooms,slot,nFichas
    global OT,AOR,COIN,Ex,I,SP,dictCosts
